...
router.post('/getmanagerbyowner', jwt.verifyToken, managerController.getManagerByOwner) //ดึง username manager มาเพื่อดูยอดขายของร้าน
...
router.post('/forget', managerController.forgetVerify) //ส่ง reset Password ไปยัง Email
router.post('/forget-password', managerController.resetPassword); // resetPassword
